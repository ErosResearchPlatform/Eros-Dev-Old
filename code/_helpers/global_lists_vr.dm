...
/hook/startup/proc/init_vore_datum_ref_lists()
	...
	// Custom Ears
	paths = typesof(/datum/sprite_accessory/ears) - /datum/sprite_accessory/ears - /datum/sprite_accessory/ears/eros	// Eros edit -- adds ears path
	for(var/path in paths)
		var/obj/item/clothing/head/instance = new path()
		ear_styles_list[path] = instance

	// Custom Tails
	paths = typesof(/datum/sprite_accessory/tail) - /datum/sprite_accessory/tail - /datum/sprite_accessory/tail/eros - /datum/sprite_accessory/tail/taur		// Eros edit -- adds tail path
	for(var/path in paths)
