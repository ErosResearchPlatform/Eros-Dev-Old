...
/datum/category_item/player_setup_item/eros/resleeve
	name = "Resleeving"
	sort_order = 2

/datum/category_item/player_setup_item/eros/resleeve/load_character(var/savefile/S)
	S["resleeve_lock"]		>> pref.resleeve_lock
	S["resleeve_scan"]		>> pref.resleeve_scan


/datum/category_item/player_setup_item/eros/resleeve/save_character(var/savefile/S)
	S["resleeve_lock"]		<< pref.resleeve_lock
	S["resleeve_scan"]		<< pref.resleeve_scan

/datum/category_item/player_setup_item/eros/resleeve/sanitize_character()
...
/datum/category_item/player_setup_item/eros/resleeve/copy_to_mob(var/mob/living/carbon/human/character)
...
/datum/category_item/player_setup_item/eros/resleeve/content(var/mob/user)
	. += "<br>"
...
/datum/category_item/player_setup_item/eros/resleeve/OnTopic(var/href, var/list/href_list, var/mob/user)
