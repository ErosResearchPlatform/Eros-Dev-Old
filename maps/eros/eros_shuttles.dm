////////////////////////////////////////
// Eros custom shuttle implemnetations
////////////////////////////////////////

/obj/machinery/computer/shuttle_control/eros_backup
	name = "eros backup shuttle control console"
	shuttle_tag = "Eros Backup"
	req_one_access = list(access_heads)

/obj/machinery/computer/shuttle_control/multi/eros_antag_ground
	name = "land crawler control console"
	shuttle_tag = "Land Crawler"

/obj/machinery/computer/shuttle_control/multi/eros_antag_space
...
//
// The backup eros shuttle uses experimental engines and can degrade and/or crash!
//
/datum/shuttle/ferry/eros_backup
	crash_message = "Eros shuttle distress signal received. Shuttle location is approximately 200 meters from eros base."
	category = /datum/shuttle/ferry/eros_backup // So shuttle_controller.dm doesn't try and instantiate this type as an acutal mapped in shuttle.
	var/list/engines = list()
	var/obj/machinery/computer/shuttle_control/eros_backup/computer

/datum/shuttle/ferry/eros_backup/New()
	..()
	var/area/current_area = get_location_area(location)
	for(var/obj/structure/shuttle/engine/propulsion/E in current_area)
		engines += E
	for(var/obj/machinery/computer/shuttle_control/eros_backup/comp in current_area)
		computer = comp

/datum/shuttle/ferry/eros_backup/process_longjump(var/area/origin, var/area/intended_destination)
